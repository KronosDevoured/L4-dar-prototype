"""
Octane Center of Mass Multi-Axis Measurement Script
...
class OctaneCenterOfMassMultiAxis(BaseAgent):
    def __init__(self, name, team, index):
        ...
        # Output directory
        self.output_dir = Path("C:/Users/itsju/AppData/Roaming/bakkesmod/bakkesmod/data/octane_com_test")
        self.output_dir.mkdir(parents=True, exist_ok=True)

    def initialize_agent(self):
        """Called once when bot starts"""
        self.logger.info("Octane Multi-Axis Center of Mass Measurement Bot initialized")
    ...
    def analyze_and_save(self):
        ...
        for axis in ['pitch', 'yaw', 'roll']:
            csv_file = self.output_dir / f"octane_com_{axis}_data.csv"
        ...
        # Save analysis
        analysis_file = self.output_dir / "octane_com_multiaxis_analysis.txt"
        with open(analysis_file, 'w') as f:
            f.write("OCTANE CENTER OF MASS MULTI-AXIS ANALYSIS\n")
            f.write("=" * 60 + "\n\n")
            ...
            f.write(f"  Measured lever (avg): {(radius_pitch + radius_yaw + radius_roll) / 3:.2f} uu\n\n")
            ...
            f.write("} else if (presetName === 'octane') {\n")
        ...
        # Print to console
        print("\n" + "=" * 60)
        print("OCTANE CENTER OF MASS MULTI-AXIS MEASUREMENT COMPLETE")
        print("=" * 60)
