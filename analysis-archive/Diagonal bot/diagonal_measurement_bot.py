...
class DiagonalMeasurementBot(BaseAgent):
    ...
    def get_output(self, packet: GameTickPacket) -> SimpleControllerState:
        ...
        if self.measuring:
            ...
            controller.handbrake = True  # DAR always active
    ...
    def save_data(self):
        ...
        with open(output_file, 'w', newline='') as f:
            fieldnames = ['time', 'wx', 'wy', 'wz', 'magnitude', 'input_pitch', 'input_yaw', 'dar_active']
