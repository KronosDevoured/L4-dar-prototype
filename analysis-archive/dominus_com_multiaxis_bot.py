...
class DominusCenterOfMassMultiAxis(BaseAgent):
    ...
    def analyze_and_save(self):
        ...
        with open(analysis_file, 'w') as f:
            ...
            f.write(f"Hitbox length: {self.car_length:.2f} uu\n\n")
        ...
        print(f"\nComparison to current L4 values:")
        print(f"  Current xOffset: -14.0, Measured: {-offset_x:.1f}")
        print(f"  Current yOffset: +15.0, Measured: {offset_z:.1f}")
        print(f"\nL4 Implementation:")
